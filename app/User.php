...
class User extends Authenticatable
{
    ...
    public function get_parent_shareholders(){
        return $this->hasMany(Models\ShareHolderRelation::class,'parent_id');
    }

    public function get_child_shareholders(){
        return $this->hasMany(Models\ShareHolderRelation::class,'child_id');
    }
